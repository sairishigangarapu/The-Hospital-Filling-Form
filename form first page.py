...
btn = Button(root, text='LOGIN(IF YOU ARE A REGULAR PATIENT)', width=50,bg="#948faf",fg='black',font=myFont,activebackground='lime',border = 0).place(x=80,y=300)
...
btn = Button(root, text='ONE TIME APPOINTMENT?CLICK THIS', width=50,bg="#948faf",fg='black',font=myFont,activebackground='lime',border = 0).place(x=60,y=450)
root.mainloop()